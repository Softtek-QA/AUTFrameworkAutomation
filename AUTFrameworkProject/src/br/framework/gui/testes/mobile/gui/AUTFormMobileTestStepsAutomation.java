 ...
 *
 */
public class AUTFormMobileTestStepsAutomation{	
							...
							if(!AUTRuntimeConfiguration.AUT_GRAVACAO_VIDEO_ATIVA) {
								...
								AUTRuntimeConfiguration.AUT_PROCESSO_GRAVACAO_VIDEO = new java.lang.Thread(new java.lang.Runnable() {
									...
									public void run() {
										...
										processoGravacao = AUTAPI.AUTProcessoExternoUtils.executarProcessoExterno("adb shell screenrecord \"".concat(AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.ANDROID_ARQUIVO_VIDEO_PADRAO.concat("\"")));
				...
				javax.swing.SwingWorker swkFormProgresso = new javax.swing.SwingWorker() {
					...
					protected Object doInBackground() throws Exception {
						...
						if(!diretorio.isEmpty()) {
							...
							AUTFormTranslateFileSyncronizeManage formProgresso = new AUTFormTranslateFileSyncronizeManage(formMobile,diretorio);
				...
				javax.swing.SwingWorker swkProcessoVD = new javax.swing.SwingWorker() {
					...
					protected Object doInBackground() throws Exception {
						...
						if(rd.isSelected()) {
							...
							AUTGUIParallelProcess procRecVD = new AUTGUIParallelProcess() {
		...
		txtConsoleSaida.addKeyListener(new java.awt.event.KeyListener() {
			...
			public void keyReleased(KeyEvent key) {
				if(rdHabilitarCMDInterativo.isSelected() || rdHabilitarCMDIntComImagem.isSelected() 
					...
					case 8:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("DEL");
						break;
					}
					case 9:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("TAB");
						break;
					}
					case 10:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("ENTER");
						break;
					}
					case 18:{
					...
					case 27:{
						if(!key.isAltDown()) {
							AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("BACK");
						}
						else {
							AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("ESCAPE");
						}
					}
					case 32:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("SPACE");
						break;
					}
					case 33:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("PAGE_UP");
						break;
					}
					case 34:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("PAGE_DOWN");
						break;
					}
					case 35:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("MOVE_END");
						break;
					}
					case 36:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("MOVE_HOME");
						break;
					}
					case 37:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("DPAD_LEFT");
						break;
					}
					case 38:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("DPAD_UP");
						break;
					}
					case 39:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("DPAD_RIGHT");
						break;
					}
					case 40:{
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarComando("DPAD_DOWN");
						break;
					}				
					default:{
						Character cmd = key.getKeyChar();
						AUTFormMobileTestStepsAutomation.AUTDispositivoConfiguracao.enviarConteudo(cmd.toString());
...
*/
	 ...
	 * 
	 */
	public AUTFormMobileTestStepsAutomation() {
		configGUI();
	}

	public AUTFormMobileTestStepsAutomation(javax.swing.JDialog form) {
