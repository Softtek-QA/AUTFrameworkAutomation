...
import br.framework.api.AUTAPI.AUTFormularioUtils;
import br.framework.api.AUTAPI.AUTPainelImagem;
import br.framework.api.AUTAPI.AUTGUIParallelProcess;
import br.framework.api.runtime.AUTRuntimeConfiguration;
import br.framework.gui.testes.mobile.gui.AUTFormMobileConector.AUTAndroidInterface;
import br.framework.gui.testes.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao;
import br.framework.gui.testes.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao.AUT_ANDROID_CONFIGURACAO_IP;
 ...
 *
 */
public class AUTFormMobileConsoleManage {
	public static java.util.List<AUTFormMobileConsoleManage> AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS = new java.util.ArrayList<AUTFormMobileConsoleManage>();
	...
	public static abstract class AUTMouseControls extends AUTGUIParallelProcess implements java.awt.event.MouseListener{
	...
	public static class AUTFormTerminalComandos{
		...
		public static class AUTDeviceTerminal extends br.framework.gui.testes.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao{
		...
		public void configGUI() {
			...
			AUTGUIParallelProcess procExecCMD = new AUTGUIParallelProcess() {
	...
	public void configGUI() {		
		...
		AUTGUIParallelProcess procAtualizarImg = new AUTGUIParallelProcess() {
		...
		AUTGUIParallelProcess procLoaderImgForTimeSlice = new AUTGUIParallelProcess() {
		...
		AUTGUIParallelProcess procLoaderDataCMDS = new AUTGUIParallelProcess() {
		...
		AUTGUIParallelProcess procLoaderDataMenuGUICMDS = new AUTGUIParallelProcess() {
			...
			protected void rotinasExecucao() {
				...
				menuItemComandoADB.addActionListener(new java.awt.event.ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						AUTGUIParallelProcess procLoaderKeys = new AUTGUIParallelProcess() {
	 ...
	 * 
	 */
	public AUTFormMobileConsoleManage(javax.swing.JDialog form) {
		formPrincipal = form;

		configGUI();
	}

	public AUTFormMobileConsoleManage(String nomeDispositivo,javax.swing.JDialog form) {
		formPrincipal = form;
