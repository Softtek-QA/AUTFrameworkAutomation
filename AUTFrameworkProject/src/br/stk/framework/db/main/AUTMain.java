...
import br.stkframework.db.management.AUTDBAPPDynamicParameters;
import br.stkframework.db.management.AUTDBAPPStaticParameters;
import br.stkframework.db.management.AUTDBApplicationConfiguration;
import br.stkframework.db.management.AUTDBBSIBaseConfiguration;
import br.stkframework.db.management.AUTDBBSIRSCLibraries;
import br.stkframework.db.management.AUTDBBSIRSCLibrariesFunctions;
import br.stkframework.db.management.AUTDBBSIResourceBase;
import br.stkframework.db.management.AUTDBBusinessAreas;
import br.stkframework.db.management.AUTDBBusinessComponent;
import br.stkframework.db.management.AUTDBBusinessComponentFunctions;
import br.stkframework.db.management.AUTDBBusinessProcess;
import br.stkframework.db.management.AUTDBComponentStepsAutomation;
import br.stkframework.db.management.AUTDBComponentStepsDefinition;
import br.stkframework.db.management.AUTDBDataColumn;
import br.stkframework.db.management.AUTDBDataColumnRuntime;
import br.stkframework.db.management.AUTDBDataFlow;
import br.stkframework.db.management.AUTDBDataRow;
import br.stkframework.db.management.AUTDBDataRowRuntime;
import br.stkframework.db.management.AUTDBDataSet;
import br.stkframework.db.management.AUTDBDataTable;
import br.stkframework.db.management.AUTDBDataTableRuntime;
import br.stkframework.db.management.AUTDBDataValueObject;
import br.stkframework.db.management.AUTDBDataValueObjectRuntime;
import br.stkframework.db.management.AUTDBDataValueText;
import br.stkframework.db.management.AUTDBDataValueTextRuntime;
import br.stkframework.db.management.AUTDBPemissionsUser;
import br.stkframework.db.management.AUTDBPhysicalWorkStation;
import br.stkframework.db.management.AUTDBProfiles;
import br.stkframework.db.management.AUTDBProject;
import br.stkframework.db.management.AUTDBResourcesConfiguration;
import br.stkframework.db.management.AUTDBScheduleEnd;
import br.stkframework.db.management.AUTDBScheduleInit;
import br.stkframework.db.management.AUTDBScheduleProcess;
import br.stkframework.db.management.AUTDBScheduleTaskManager;
import br.stkframework.db.management.AUTDBServicesConfiguration;
import br.stkframework.db.management.AUTDBSessionsUsers;
import br.stkframework.db.management.AUTDBSubBusinessProcess;
import br.stkframework.db.management.AUTDBSubProcessFunctions;
import br.stkframework.db.management.AUTDBTasksComponents;
import br.stkframework.db.management.AUTDBUsers;
import br.stkframework.db.management.AUTDBVirtualMachine;
