...
import br.stk.framework.db.management.AUTDBProfiles.AUT_PROFILES_OPERATIONS;
...
public class AUTDBProject extends AUTJDBCProcess {	
	...
	AUTFWKTestObjectBase fwkObjBase = null;
	...
	public AUTFWKTestObjectBase autGetFrameworkIntegrationObject() {
		if(fwkObjBase==null) {
			return new AUTFWKTestObjectBase();
		}
		else {
			return fwkObjBase;
		}
