...
public class AUTDBProcessDataFlow extends AUTDBProject {
	...
	public java.util.HashMap<Integer,java.util.HashMap<String,Object>> autSelectValuesByParameters(java.util.HashMap<String,Object> parameters) {
		try {
			...
			java.util.HashMap<Integer,java.util.HashMap<String,Object>> paramsOut = (HashMap<Integer, HashMap<String, Object>>) autDBParameterManagerDataFlow(AUT_SQL_OPERATIONS_PROCESS_PARAMETERS.SELECT_PARAMETER, null, AUT_SQL_OPERATIONS_CONDITIONS.SELECT_DATAFLOW_PARAMETER_BY_PROJECT_AND_SCENARIO_AND_COLUMN_NAME, parametersInput, parametersConditions);
