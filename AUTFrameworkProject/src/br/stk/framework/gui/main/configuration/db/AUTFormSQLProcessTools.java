package br.stk.framework.gui.main.configuration.db;
 ...
 *
 */
public class AUTFormSQLProcessTools {
	 ...
	 * 
	 */
	public AUTFormSQLProcessTools(javax.swing.JDialog form) {
		formPrincipal = form;
		configGUI();
	}
