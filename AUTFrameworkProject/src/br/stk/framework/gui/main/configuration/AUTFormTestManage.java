...
import br.stk.framework.gui.main.configuration.db.AUTFormSQLProcessTools;
 ...
 *
 */
public class AUTFormTestManage {
	...
	public javax.swing.JPanel configGUITabDB(javax.swing.JDialog frm){
		...
		menuGerConnect.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				AUTFormSGDBIntegration formConnect = new AUTFormSGDBIntegration(formPrincipal);
			}
		});
		...
		menuEditorCodigo.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				AUTFormSQLProcessTools formFerramentaSQL = new AUTFormSQLProcessTools(frm);
			}
		});
	 ...
	 * 
	 */
	public AUTFormTestManage(javax.swing.JDialog form) {
		formPrincipal = form;
		configGUI();
	}
}
