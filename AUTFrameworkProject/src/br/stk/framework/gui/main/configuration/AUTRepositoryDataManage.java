...
public class AUTRepositoryDataManage {
	/**
	 * 
	 ...
	 * 
	 * 
	 * @param formularioPrincipal - Formulário principal
	 * 
	 */
		...
		botaoSalvar.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				if(java.nio.file.Files.isDirectory(pasta, java.nio.file.LinkOption.NOFOLLOW_LINKS)) {
					AUTLogsManage.registrarLog("PARA EVIDENCIAS: DIRETORIO CONFIGURADO CORRETAMENTE");
					AUTLogsManage.registrarLog(dir);
				}
				else {
				...
				if(java.nio.file.Files.isDirectory(pastaConfiguracoes, java.nio.file.LinkOption.NOFOLLOW_LINKS)) {
					AUTLogsManage.registrarLog("PARA AS CONFIGURACOES: DIRETORIO CONFIGURADO CORRETAMENTE");
					AUTLogsManage.registrarLog(pastaConfiguracoes);
				}
				else {
