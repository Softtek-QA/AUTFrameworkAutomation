...
import br.stk.framework.gui.api.AUTAPIGUI.AUTFormularioUtils;
import br.stk.framework.gui.api.AUTAPIGUI.AUTPainelImagem;
...
import br.stk.framework.test.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao.AUT_ANDROID_CONFIGURACAO_IP;
...
public class AUTFormConsoleMobile {
	...
	public static class AUTFormTerminalComandos{
		...
		public static class AUTDeviceTerminal extends br.stk.framework.test.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao{
		...
		public void configGUI() {
			...
			AUTProcessoParalelo procExecCMD = new AUTProcessoParalelo() {
				...
				public br.stk.framework.test.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao.AUTAndroidInterface adbObjectInterface = autAdbConfig.autAdbInterfaceFactory();
				public br.stk.framework.test.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao.AUTAndroidInterface.AUTAndroidObject autAdbObject = adbObjectInterface.autFactoryAdbObject();
				...
				protected void rotinasExecucao() {
					...
					for(Object step : keysCmd) {
						...
						for(Object actItem : AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS.get(AUT_ID_MOB_CONSOLE).ltCmdTerminal.get(step).values()) {
							...
							AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS.get(AUT_ID_MOB_CONSOLE).listIMGS.add(autAdbObject.carregarImagem(nmDevice,AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS.get(AUT_ID_MOB_CONSOLE).posCorrente,AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS.get(AUT_ID_MOB_CONSOLE).scrIMG.getSize().width,AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS.get(AUT_ID_MOB_CONSOLE).scrIMG.getSize().height));
	...
	public void configGUI() {		
		...
		AUTProcessoParalelo autCarregarGUI = new AUTProcessoParalelo() {
			...
			protected void rotinasExecucao() {
				...
				autAdbObject.carregarArvoreObjetosXML(autAdbObject.carregarXMLConfiguracao(), treeDadosEntrada);
			}
		...
		scrIMG.setName("AUTIMG_CONTAINER".concat(nmDispositivo));
		...
		AUTProcessoParalelo procLoaderImg = new AUTProcessoParalelo() {
			...
			protected void rotinasExecucao() {
				...
				listIMGS.add(autAdbObject.carregarImagem(nmDispositivo,AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS.get(AUT_ID_MOB_CONSOLE).posCorrente,AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS.get(AUT_ID_MOB_CONSOLE).scrIMG.getSize().width,AUT_LISTA_FORM_MOB_CONSOLE_INSTANCIAS.get(AUT_ID_MOB_CONSOLE).scrIMG.getSize().height));
