 ...
 *
 */
public class AUTFormAnexosGerenciamento {
	...
	public void configGUI() {
		...
		btAdicionar.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				AUTFormSelectTipoAnexo formTipoAnexo = new AUTFormSelectTipoAnexo(formGerenciadorAnexo);
			}
		});
	 ...
	 * 
	 */
	public AUTFormAnexosGerenciamento(javax.swing.JDialog form) {
		formPrincipal = form;
		configGUI();
	}
	
	public AUTFormAnexosGerenciamento() {
		configGUI();
	}
}
