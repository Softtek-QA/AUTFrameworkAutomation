 ...
 *
 */
public class AUTFormGerenciamentoModulos {
	...
	public void configGUI() {
		...
		btGerenciarAnexos.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				AUTFormAnexosGerenciamento formAnexos = new AUTFormAnexosGerenciamento(formGerenciamentoModulos);
			}
		});
	 ...
	 * 
	 */
	public AUTFormGerenciamentoModulos() {
		configGUI();
	}	
	 ...
	 * 
	 */
	public AUTFormGerenciamentoModulos(javax.swing.JDialog form) {
		formPrincipal = form;
		configGUI();
