 ...
 *
 */
public class AUTFormGerenciarCenarios {
	...
	public void configGUI() {
		...
		btAnexosMDManual.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				AUTFormAnexosGerenciamento formAnexos = new AUTFormAnexosGerenciamento(formGerenciamentoCenarios);
			}
		});
	 ...
	 * 
	 */
	public AUTFormGerenciarCenarios() {
		configGUI();		
	}
	 ...
	 * 
	 */
	public AUTFormGerenciarCenarios(javax.swing.JDialog form) {
		formPrincipal = form;
		configGUI();
	}
}
