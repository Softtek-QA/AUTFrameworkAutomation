package br.stk.framework.frontend.main.configuracao;
...
import br.stk.framework.gui.api.AUTAPIGUI.*;
import br.stk.framework.gui.api.AUTAPIGUI.AUTJDBCConector.*;
import br.stk.framework.gui.api.runtime.AUTRuntimeConfiguration;
import br.stk.framework.gui.handle.eventos.AUTEventosJanela;
 ...
 *
 */
public class AUTConexoesBaseDados {
	 ...
	 * 
	 */
	public AUTConexoesBaseDados() {
		super();
		configurarGUI();
	}
	
	public AUTConexoesBaseDados(javax.swing.JDialog formulario) {
	...
	public void configurarGUI() {
		...
		formularioConexao.addWindowListener(new AUTEventosJanela() {			
			@Override
			...
			public void janelaExibidaNaTela(WindowEvent evento) {
				AUTGerenciadorLogs.registrarLog(evento);
		...
		botaoTestar.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent e) {
				AUTGerenciadorLogs.habilitarCapturaListaLogs();
				...
				for(Object item : AUTGerenciadorLogs.carregarMensagensLog()) {
		...
		botaoIrParaManutencao.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent e) {
				AUTGerenciadorLogs.registrarLog(String.format("INFO : VARIAVEL AMBIENTE : CLASSPATH :",java.lang.System.getenv("classpath")));
