...
import br.stk.framework.frontend.main.configuracao.*;
...
import br.stk.framework.test.mobile.gui.AUTFormMobileTesteManual;
...
public class AUTFrameworkMain {	
	...
	public void configurarInicializacaoGUI() {	
		...
		subMenuSair.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent e) {
				AUTGerenciadorLogs.registrarLog("INFO : FINALIZANDO APLICATIVO PRINCIPAL DE CONFIGURAÇÃO DO FRAMEWORK");				
