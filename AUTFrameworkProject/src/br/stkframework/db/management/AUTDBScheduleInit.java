...
/**
 * 
 * Gerenciamento de agendamento de tarefas voltadas para processos de inicialização:
 * FUNÇÕES - CARREGAMENTO E INICIALIZAÇÃO
 *  
 * @author Softtek-QA
 *
 */
public class AUTDBScheduleInit extends AUTDBScheduleTaskManager{
	...
	/**
	 * 
	 * Comandos para o gerenciamento de tarefas de inicialização
	 * 
	 * @author Softtek-QA
	 *
	 */
	...
	/**
	 * 
	 * Inclui agenda uma nova tarefa de inicialização para uma tarefa de gerenciamento do componente de negócio
	 * 
	...
	/**
	 * 
	 * Lista todas as tarefas de inicialização registradas no sistema
	 * 
	...
	/**
	 * 
	 * Lista todas as tarefas de inicialização agendas para uma tarefa de gerenciamento
	 * 
