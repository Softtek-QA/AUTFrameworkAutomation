package br.softtek.framework.testes.mobile.gui;
...
public class AUTFormConsoleMobile {
	...
	public static class AUTFormTerminalComandos{
		...
		public static class AUTDeviceTerminal extends br.softtek.framework.testes.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao{
		...
		public void configGUI() {
			...
			AUTProcessoParalelo procExecCMD = new AUTProcessoParalelo() {
				...
				public br.softtek.framework.testes.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao.AUTAndroidInterface adbObjectInterface = autAdbConfig.autAdbInterfaceFactory();
				public br.softtek.framework.testes.mobile.gui.AUTFormMobileConector.AUTDispositivoConfiguracao.AUTAndroidInterface.AUTAndroidObject autAdbObject = adbObjectInterface.autFactoryAdbObject();
